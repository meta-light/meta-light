...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `bradautomates-head-of-content-x-research`                                |
| Version    | 1.0.1                                     |
...
**GitHub:** [bradautomates/head-of-content](https://github.com/bradautomates/head-of-content) — ⭐ 23 | Forks: 6
...
X/Twitter Research automates discovery of high-performing tweets from tracked accounts, flags statistical outliers, and optionally analyzes video content for hooks, pacing, and structure using Gemini. Key features include batch fetching via Apify Tweet Scraper V2, configurable time windows and max items, outlier detection with adjustable threshold, and structured JSON outputs (total_posts, outlier_count, topics, content_patterns, accounts, outliers). Use cases: competitor analysis, niche trend discovery, content strategy development, and generating tweet or video concepts based on proven formats. Core advantages are reproducible run folders, API-driven scalability, explicit prerequisites (APIFY_TOKEN, GEMINI_API_KEY for video), and actionable outputs that surface top hashtags, mentions, keywords, and format patterns to inform creative decisions and grow engagement while respecting API limits.
...
```bash
npx -y @lobehub/market-cli skills install bradautomates-head-of-content-x-research
```
...
npx -y @lobehub/market-cli skills install bradautomates-head-of-content-x-research --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install bradautomates-head-of-content-x-research --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install bradautomates-head-of-content-x-research --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install bradautomates-head-of-content-x-research --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install bradautomates-head-of-content-x-research --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate bradautomates-head-of-content-x-research --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment bradautomates-head-of-content-x-research -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comments bradautomates-head-of-content-x-research
```
...
Download and install a skill from the marketplace. The CLI handles authentication automatically.
