    ...
    while (page) {
      const response = await fetch(url, {
        ...
        body: JSON.stringify({
          ...
          params: { groupKey: "collection", groupValue: groupValue, page: page, limit: 1000 },
        }),
      });
  ...
  return (
    <div>
      ...
      <button
        ...
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded font-mono"
        >
        Submit
        </button>
        </div>
